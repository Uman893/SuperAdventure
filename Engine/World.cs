...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Item(ITEM_ID_ADVENTURER_PASS, "Aventurer pass", "Adventurer passes"));
        }
        ...
        {
            Quest clearAchemistGarden = new Quest(QUEST_ID_CLEAR_ALCHEMIST_GARDEN, "Clear the alchemist's garden",
                "Kill rats in the aöchemist's garden and bring back 3 rat tails. " +
                "You will receive a healing potion and 10 gold pieces", 20, 10);

            clearAchemistGarden.QuestCompletionItems.Add(new QuestCompletionItem(ItemByID(ITEM_ID_RAT_TAIL), 3));

            clearAchemistGarden.RewardItem = ItemByID(ITEM_ID_HEALING_POTION);
            ...
            Quests.Add(clearAchemistGarden);
        ...
        private static void PopulateLocations()
        {
            ...
            Location alchemistsGarden = new Location(LOCATION_ID_ALCHEMISTS_GARDEN,
                "Alchemist's garden", "Many platns are growing here.");
            ...
            Location bridge = new Location(LOCATION_ID_BRIDGE,
                "Bridge", "A stone bridge corsses a wide river.");
